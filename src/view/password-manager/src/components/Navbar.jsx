...
export function Navbar() {
    ...
    return (
        <nav className="bg-dark-blue-1 text-white inset-0 w-[250px] h-[100vh] pt-4 fixed">
            <img src={images.logo} className="h-7 mx-auto"/>
            <ul className="flex flex-col text-lg mt-8">
                <li>
                    <button onClick={changeFocus}
                            ...
                            flex">
                        <img src={images.managerIcon} className="w-7 h-7 mr-4"/>
                        Accounts
                    </button>
                </li>
                <li>
                    <button onClick={changeFocus}
                            ...
                            transition flex">
                        <img src={images.generatorIcon} className="w-7 h-7 mr-4"/>
                        Generator
                    </button>
                </li>
                <li>
                    <button onClick={changeFocus}
                            className="change-focus w-full text-start pl-8 py-3 hover:bg-dark-blue-2
                            transition flex">
                        <img src={images.settingsIcon} className="w-7 h-7 mr-4"/>
                        Settings
                    </button>
                </li>
            </ul>
