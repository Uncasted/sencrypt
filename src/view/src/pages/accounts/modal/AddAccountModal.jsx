...
import {ADD_MODAL_FIELDS, BLUE_OUTLINE, HOSTNAME_REGEX, RED_OUTLINE} from "../../../data/constants"
...
export function AddAccountModal() {
    ...
    const submitData = (event) => {
        ...
        const isNotDuplicate = accounts.every(account => {
            return account.username !== newAccountData.username || account.website !== newAccountData.website
        })
